...
export const tabCameraInfo = () => {
  return {
    站内设施: [
      504793.48203125, 2499688.4006250002, 248.09537109375, -60.87890625, 148.35487365722656, 0.0
    ],
    车辆充电: [
    ...
    电流流转: 4,
    运营商分布: [
      504807.40734375, 2499714.140703125, 217.183515625, -46.425331115722656, 145.0386505126953, 0.0
    ]
  };
};
