...
<template>
  ...
  <panel>
    ...
    <div class="charging-peak-area">
      <title-column title="充电高峰区域情况" :showTabBtn="true" :tabList="[{value:1,name:'日'},{value:2,name:'月'},{value:3,name:'年'}]"  @handleTabBtn="handleYearBtn"/>
...
// 默认区
const defaultArea = ref([440303,440304,440305,440306,440307,440308,440309,440310,440311,440343,441521])
// 当前底部button高亮的对象
